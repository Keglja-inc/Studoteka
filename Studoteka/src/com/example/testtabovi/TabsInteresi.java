...
import com.example.interesi.InteresiAdapter;
import com.example.interesi.OsobniInteresi;
import com.example.studoteka.R;


public class TabsInteresi extends FragmentActivity implements TabListener, TabCommunication{
	...
	private ArrayList<String> poslano;
	...
	public void SendData(ArrayList<String> data) {
		...
		OsobniInteresi oi = (OsobniInteresi) getSupportFragmentManager().findFragmentById(R.id.pager);
		oi.receiveData(data);
	}
}
