...
public class OsobniInteresi extends Fragment {
	...
	private ArrayAdapter<Interes> adapter;
	private String mail;
	private ArrayList<Interes> list = new ArrayList<Interes>();
	private FakultetiModel fm;
	private ArrayList<FakultetiModel> listaFM = new ArrayList<FakultetiModel>();
	private String url = "http://46.101.185.15/rest/37ecc108d4142d31b0bac403328b644ab2cf6b9d";

	TabCommunication com2;
	...
	public void receiveData(ArrayList<Interes> data) {
		list.clear();
		list = data;
		adapter = new ArrayAdapter<Interes>(getActivity(),
