...
public class DBAdapter {
	...
	public static String getProfilData(String pass) throws SQLException {
		...
		Cursor cursor = db.query(USER_TABLE, null, KEY_PASSWORD + "=?",
		 ...
		 * KEY_USER_NAME,KEY_USER_LAST_NAME, KEY_USER_EMAIL,KEY_PASSWORD },
		 * KEY_PASSWORD + "='"+pass+"'", new String[] { String.valueOf(pass) },
		 * null, null, null, null);
		 * 
		 * 
		 * if(cursor.getCount()<1) // UserName Not Exist { cursor.close();
		 * return "Ne postoji korisnik..."; } cursor.moveToNext();
		 * 
		 * String email= cursor.getString(cursor.getColumnIndex("email"));
		 * cursor.close(); Log.d("MAILLLLLL", email.toString()); return email;
		 */
	}
	...
	public static String getProfilDataFUll2(String ime) throws SQLException {
		Log.e("UserData", "Radi");
		final SQLiteDatabase db = open();
		...
		String podaci = cursor.getString(cursor.getColumnIndex("ime")) + ","
				+ cursor.getString(cursor.getColumnIndex("ime")) + ","
				+ cursor.getString(cursor.getColumnIndex("prezime")) + ","
				+ cursor.getString(cursor.getColumnIndex("mail"));
		cursor.close();
		return podaci;
	...
	public static Boolean checkUser(String username, String password)
		...
		Cursor cursor = db.query(true, USER_TABLE, new String[] {
				KEY_USER_NAME, KEY_PASSWORD }, KEY_USER_NAME + "='" + username
				+ "' AND " + KEY_PASSWORD + "='" + password + "'", null, null,
				null, null, null);
