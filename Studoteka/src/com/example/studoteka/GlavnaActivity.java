...
public class GlavnaActivity extends ActionBarActivity implements
		OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// drawer layoutu kažemo da je draverListenerToogle objekt koji prima
		...
		// dobijemo malu strelicu kraj home ikone te sada možemo, ukoliko imamo
		// više ekrana klikom na Home ikonu
	...
	// služi da kada se promjeni konfiguracija (npr. velièina ekrana) da se
