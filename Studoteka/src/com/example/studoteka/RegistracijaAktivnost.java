	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spremi.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				RegistracijaLokalna registracija = new RegistracijaLokalna(imeKorisnika, prezimeKorisnika, emailKorisnika, lozinkaKorisnika);
				if(registracija.registracijaKorisnika()){
					...
					if(lozinkaKorisnika.equals(potvrdaLozinke)){
						...
						try {
							DBAdapter.addUserData(new UcenikModel(imeKorisnika, prezimeKorisnika, emailKorisnika, lozinkaKorisnika));
						} catch (SQLException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}
						
						Toast.makeText(RegistracijaAktivnost.this, "Uspješno ste se regristrirali...", Toast.LENGTH_LONG).show();
					...
					{	
						Toast.makeText(RegistracijaAktivnost.this, "Niste unijeli dobru lozinku, ponovite...", Toast.LENGTH_LONG).show();
					}
				}
			}
		});
