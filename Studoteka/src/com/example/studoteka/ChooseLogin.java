...
public class ChooseLogin extends FragmentActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_login_obicno:
			...
			/*
			 * lg = new LoginActivity(); android.support.v4.app.FragmentManager
			 * fm = getSupportFragmentManager(); FragmentTransaction ft =
			 * fm.beginTransaction(); ft.replace(android.R.id.content,
			 * lg).setTransition
			 * (FragmentTransaction.TRANSIT_FRAGMENT_FADE).addToBackStack(null);
			 * ft.commit();break;
			 */
